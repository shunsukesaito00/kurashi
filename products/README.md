...
手取り試算・手取り比較・家計サマリ・README の4シート入り Excel テンプレート。計算式は [`docs/spreadsheet-spec.md`](../docs/spreadsheet-spec.md) および `tools/tedori.html` と同一。
...
ZIP に本 xlsx と簡易PDFマニュアルを同梱する想定。積立メモ・年間俯瞰シートは次フェーズ。
