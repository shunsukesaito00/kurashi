...
手取り試算・手取り比較・README の3シート入り Excel テンプレート。計算式は [`docs/spreadsheet-spec.md`](../docs/spreadsheet-spec.md) および `tools/tedori.html` と同一。
...
ZIP に本 xlsx と簡易PDFマニュアルを同梱する想定。家計サマリ等の追加シートは次フェーズ。
